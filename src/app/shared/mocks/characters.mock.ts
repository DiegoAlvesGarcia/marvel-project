import { Data } from "../interfaces/character.interface";

export const characterMock: Data = {
    offset: 0,
    limit: 2,
    total: 1559,
    count: 2,
    results: [
        {
            ...
            urls: [
                {
                    type: "detail",
                    url: "http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=eda97eb5ae79e64b47b53b5b42531fec"
                },
                {
                    type: "wiki",
                    url: "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=eda97eb5ae79e64b47b53b5b42531fec"
                },
                {
                    type: "comiclink",
                    url: "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=eda97eb5ae79e64b47b53b5b42531fec"
                }
            ]
        },
        {
            ...
            urls: [
                {
                    type: "detail",
                    url: "http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=eda97eb5ae79e64b47b53b5b42531fec"
                },
                {
                    type: "comiclink",
                    url: "http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=eda97eb5ae79e64b47b53b5b42531fec"
                }
            ]
        }
    ]
